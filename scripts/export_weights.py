...
checkpoint_path = '/home/wangtianyu/my_resnet20/autorun/20250723_183953/best_model.pth'
...
for name, param in state_dict.items():
    ...
    # 保存为 CSV 文件
    pd.DataFrame(param_np).to_csv(f'/home/wangtianyu/my_resnet20/weights/prune/test/{name}.csv', header=False, index=False)
